...
enum ApplicationStatus : Codable, Hashable, Identifiable, Comparable {
    ...
    func possibleNexts() -> [ApplicationStatus] {
        ...
        case .applied: [.oa, .phoneScreen, .interview(round: 1), .rejected, .offer, .ghost]
        case .oa: [.phoneScreen, .technicalTest, .interview(round: 1), .rejected, .ghost]
        case .phoneScreen: [.technicalTest, .interview(round: 1), .rejected, .ghost]
        case .technicalTest: [.interview(round: 1), .rejected, .ghost]
        case .interview(let round): [.interview(round: round + 1), .rejected, .offer, .ghost]
        case .rejected: []
